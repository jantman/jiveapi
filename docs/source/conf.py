# -*- coding: utf-8 -*-
#
# jiveapi documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'jiveapi.tex', u'jiveapi Documentation',
...
man_pages = [
    (master_doc, 'jiveapi', u'jiveapi Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'jiveapi', u'jiveapi Documentation',
   author, 'jiveapi', 'One line description of project.',
   'Miscellaneous'),
]
